#ამჟამად 5 ლეიერიანს ყველა ტექნიკა ჩავუმატე: batch norm + attention + skipping
import torch
...
def chemi_preds_final():
    print("ამჟამად განვიხილავ 5 ლეიერიან CNN + ყველა ტექნიკას და ვნახავთ რამდენად კარგად იმუშავებს")
    print("batch norm + attention + skip connections - შეიძლება ცოტა რთული იყოს, მაგრამ საინტერესოა ტესტირება")


if __name__ == "__main__":
    print("Five layer with ALL techniques (BatchNorm + Attention + Skip) CNN is loading...")
