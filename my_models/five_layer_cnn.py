#ახლა მაქვს 5 ლეიერიანი cnn
#ჯერ-ჯერობით ყველაზე კარგია
import torch
...
class FiveLayerCNN(nn.Module):
    ...
    def curr_m_params(self):  
        return { 
            ...
            'details': '5 layered CNN - Clean architecture for Phase 1',  
            'my_prediction': 'Should show some overfitting without dropout',
            'all_params': self.parameters_to_train(),
            'layers used': ['Conv2d(1->32, 3x3)', 'MaxPool2d(2x2)','Conv2d(32->64, 3x3)', 'MaxPool2d(2x2)', 'Conv2d(64->128, 3x3)','Conv2d(128->256, 3x3)', 'MaxPool2d(2x2)','Conv2d(256->512, 3x3)','Linear(18432->512)', 'Linear(512->128)', 'Linear(128->7)'
            ],
        }
...
def build_FiveLayerCNN(num_classes=emotion_const):
    return FiveLayerCNN(num_classes)  

def chemi_preds_final():
    print("ახლა ვცდით 5 ლეიერიან cnn-ს Phase 1-ისთვის")
    print("ეს არის clean version dropout-ის გარეშე")
    print("ოპტიმალურ ზღურბლზე ვართ architectural depth comparison-ისთვის")
    

if __name__ == "__main__":
    print("Five layer CNN is loading...")
    curr_m = build_FiveLayerCNN()
